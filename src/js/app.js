...
let showWeather = () => {
  ...
  let url = `https://api.openweathermap.org/data/2.5/find?q=${userInput}&units=metric&APPID=3f97ec7c1a1fbcea52329fce776a3af1`
...
let weatherForecast = (name) =>{
  ...
  let url = `https://api.openweathermap.org/data/2.5/forecast?q=${name}&units=metric&APPID=3f97ec7c1a1fbcea52329fce776a3af1`
  let xhr = new XMLHttpRequest();
  // OPEN - type, url/file, async
  xhr.open('GET', url, true);
  xhr.onload = function(){
